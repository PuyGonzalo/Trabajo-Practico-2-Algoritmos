...
/**************Comienzo de función de destrucción de año de Track*****************/
status_t ADT_Track_destroy_year (ADT_Track_t *track)
{
	if(track==NULL) 
	return ERROR_NULL_POINTER;
...
/**************Final de función de destrucción de año de Track*****************/
...
status_t ADT_Track_delete(ADT_Track_t *track)
{
	...
	ADT_Track_destroy_title(track);
	ADT_Track_destroy_artist(track);
	ADT_Track_destroy_genre(track);
	ADT_Track_destroy_album(track);
	ADT_Track_destroy_year(track);
	ADT_Track_destroy_comment(track);
	ADT_Track_destroy_tag(track);
